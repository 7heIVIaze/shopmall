              ...
              <v-card>
                ...
                <v-card-text>
                  <v-row><pre><v-rating
                            ...
                            ></v-rating></pre>
                            <span style="float:flex;">{{ productDetail.productRating }} ({{ totalreview }})
                            </span>
                    </v-row>
                ...
                <v-text-field v-model="leglength" class="mx-4" label="바지 기장" max="50" min="1" step="1" style="width: 125px" type="number"></v-text-field>
                <v-card-actions>
                ...
                <template v-for="(commentItem, index) in productComment">
                  <v-list-item :key="'A' + index">
                    ...
                    <v-list-item-content>
                      ...
                      <v-row><span style="float:flex;">{{ commentItem.commentRating }}/5</span>
                      <v-list-item-subtitle class="mx-0"><pre><v-rating
                              color="yellow darken-3"
                              background-color="grey darken-1"
                              empty-icon="$ratingFull"
                              half-increments
